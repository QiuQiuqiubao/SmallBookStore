                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach var="p" items="${list2}">
                                        <tr class="odd gradeX">
                                            <td class="center">${p.customerId}</td>
                                            <td class="center">${p.customerName}</td>
                                            <td class="center">${p.customerPwd}</td>
                                            <td class="center">${p.customertruename}</td>
                                            <td class="center">${p.customerSex}</td>
                                            <td class="center">${p.customerTel}</td>
                                            <td class="center">${p.customerEmail}</td>
                                            <td class="center">${p.customerAddr}</td>
                                            <td class="center">
                                            <a href="servlet/CustomerUpdateShowListSelvert?id2=${p.customerId}"><i class="material-icons dp48">mode_edit</i></a>
					<strong>|</strong><a href="servlet/CustomerDeleteListSelvert?id=${p.customerId}&flag2=List2"
                                            onclick="return confirmDelete()"><i class="material-icons dp48">delete</i></a></td>
                                        </tr>
                                       </c:forEach>
                                    </tbody>
                                </table>

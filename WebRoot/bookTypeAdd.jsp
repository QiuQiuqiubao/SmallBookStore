...
<li><a href="login.html"><i class="fa fa-sign-out fa-fw"></i>登出</a>
		...
		<div id="page-wrapper">
		  ...
		  <form id="form1" name="form1" method="post" action="servlet/BookTypeAddListSelvert?id1=${b.bookTypeId}&flag3=List3">
					<table width="100%" border="1" align="center" cellpadding="0"
						cellspacing="0" bgcolor="#E7E7E7">
						<c:forEach var="student" itemt=${students} varStatus="status">
						<tr>
							...
							<td height="30" align="left"><label for="textfield"></label>
								...
								id="textfield" value="x" disabled="true"/></td>
						</tr>
						</c:forEach>
						...
						<tr>
							...
							<td height="30" align="left"><input height="20" width="400"
								type="text" name="bookTypeName" id="textfield3"  value=""/></td>
						</tr>
						<tr>

                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        ...
                                        <tr>
                                        <a href="bookTypeAdd.jsp"><i class="material-icons dp48">playlist_add</i></a>
                                        <th class="center">图书ID</th>
                                        <th class="center">图书种类</th>
                                    ...
                                    <c:forEach var="b" items="${list3}">
                                        <tr class="odd gradeX">
                                            <td class="center">${b.bookTypeId}</td>
                                            <td class="center">${b.bookTypeName}</td>
                                            <td class="center">
                                            <a href="servlet/BookUpdateShowListSelvert?id2=${b.bookTypeId}"><i class="material-icons dp48">mode_edit</i></a><strong>|</strong><a href="servlet/BookTypeDeleteListSelvert?id=${b.bookTypeId}&flag3=List3"
                                            onclick="return confirmDelete()"><i class="material-icons dp48">delete</i></a>

...
public class CustomerUpdateShowListSelvert extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CustomerUpdateShowListSelvert() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Customer cus=cd.searchById(id2);
		request.setAttribute("p",cus);

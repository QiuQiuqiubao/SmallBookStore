...
public class BookTypeUpdateListSelvert extends HttpServlet {
	/**
	 * Constructor of the object.
	 */
	public BookTypeUpdateListSelvert() {
		super();
	}
	/**
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int ret=bd.updateProject(book, id);
		System.out.print("ret="+ret);
		if(ret>0){
			request.getRequestDispatcher("BookTypeListSelvert").forward(request, response);
